...
<script>
        ...
        cyDHtml +=
          '<tr>' +
            ...
            '<td class="text-center ' + bgClass + '">' +
              ...
              '<a href="' + contextPath + '/CatalogoServiciosCliente?matriculaAuto=' + encodeURIComponent(v.matricula) + '" class="btn btn-sm btn-link text-success p-0" title="Agregar servicio"><i class="bi bi-plus-circle fs-5"></i></a>' +
            '</td>' +
            '<td class="text-center ' + bgClass + '">' +
  ...
  async function verServiciosAuto(matricula, nombreAuto) {
    ...
    document.getElementById('btnAgregarServicioModal').href = contextPath + '/CatalogoServiciosCliente?matriculaAuto=' + encodeURIComponent(matricula);
